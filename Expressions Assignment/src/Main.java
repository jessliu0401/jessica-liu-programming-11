public class Main {
    public static void main(String args[]){
        ...
        */
        ...
        //Expression 5 (For this expression I just leave it as a decimal according to what you say)
        ...
        System.out.println((10 * 0.707 + 2) - Math.pow(5, 3));
        System.out.println((7.07 + 2) - Math.pow(5, 3));
        System.out.println(9.07 - Math.pow(5, 3));
        System.out.println(9.07 - 125);
        System.out.println(9.07 - 125);
        System.out.println(-115.93)
